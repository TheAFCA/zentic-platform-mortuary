      ...
      <div class="ss-grid">
              ...
              <li class="ss-step">
                ...
                <div class="ss-step__body">
                  <p>
                    ...
                    <a routerLink="/admin/streaming/new">Streaming → Nuevo evento</a> con los datos
                    del servicio y del difunto
                  </p>
                </div>
              </li>
              <li class="ss-step">
                ...
                <div class="ss-step__body">
                  <p>
                    <strong>Obtienes las credenciales</strong> — al crear el evento, el sistema
                    genera una <strong>Stream Key</strong> única y una
                    <strong>URL RTMP</strong> exclusivas
                  </p>
                </div>
              </li>
              <li class="ss-step">
                ...
                <div class="ss-step__body">
                  <p>
                    <strong>Configuras OBS</strong> — en tu computadora de la sede, abres OBS
                    Studio, pones la URL RTMP como Servidor y la Stream Key como Clave
                  </p>
                </div>
              </li>
              <li class="ss-step">
              ...
              <li class="ss-step">
                ...
                <div class="ss-step__body">
                  <p>
                    ...
                    <code>/e/:slug</code> y ellos ven la ceremonia en vivo desde su celular
                  </p>
                </div>
              </li>
            </ul>
        ...
        <div class="ss-card">
          ...
          <div class="ss-card__body">
            <div class="ss-info-box ss-info-box--info">
              ...
              <div>
                <strong>Importante:</strong> Cada evento tiene su propia Stream Key única. Debes
                copiar la clave del evento específico que vas a transmitir.
              </div>
            </div>
        ...
        <div class="ss-card">
          <div class="ss-card__header">
            ...
            <h3>
              Configurar OBS Studio paso a paso <span>— programa gratuito para transmitir</span>
            </h3>
          </div>
          <div class="ss-card__body">
            <ul class="ss-obs-steps">
              ...
              <li>
                <mat-icon class="check">check_circle</mat-icon>
                <span
                  >En <strong>Servicio</strong> selecciona <strong>"Personalizado…"</strong></span
                >
              </li>
              <li>
                <mat-icon class="check">check_circle</mat-icon>
                <span
                  >En <strong>Servidor</strong> pega la URL RTMP:
                  <code>rtmps://global-live.mux.com:443/app</code></span
                >
              </li>
              <li>
                <mat-icon class="check">check_circle</mat-icon>
                <span
                  >En <strong>Clave de transmisión</strong> pega la Stream Key del evento (la copias
                  desde Streaming → ver evento → Credenciales)</span
                >
              </li>
              <li>
                <mat-icon class="check">check_circle</mat-icon>
                <span
                  >En <strong>Salida</strong> (opcional): resolución 1920×1080, bitrate 2500–4000
                  Kbps</span
                >
              </li>
              <li>
                <mat-icon class="check">check_circle</mat-icon>
                <span
                  >OBS empezará a transmitir cuando le des clic a
                  <strong>"Iniciar transmisión"</strong> en OBS. Haz esto después de presionar
                  "Iniciar transmisión" en el panel de ZENTIC.</span
                >
              </li>
            </ul>
            ...
            <div class="ss-info-box ss-info-box--tip">
              ...
              <div>
                <strong>Tip:</strong> Prueba la configuración antes del evento. Crea un evento de
                prueba, inicia la transmisión desde el panel y verifica que OBS se conecte
                correctamente.
              </div>
            </div>
          </div>
              ...
              <div class="ss-events-list">
                @for (ev of events(); track ev.id) {
                  <a [routerLink]="['/admin/streaming', ev.id]" class="ss-event-item">
                    ...
                    <span class="ss-status-chip {{ statusClass(ev.status) }}">{{
